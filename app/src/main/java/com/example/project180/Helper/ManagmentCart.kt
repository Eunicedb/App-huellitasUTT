...
class ManagmentCart(val context: Context) {
    ...
    fun insertItems(item: ItemsModel) {
        ...
        Toast.makeText(context, "Añadir a tu carrito", Toast.LENGTH_SHORT).show()
    }
    ...
    // Método nuevo para obtener una lista sin modificar cantidades
    fun getCartItemsForTicket(): List<ItemsModel> {
        return getListCart() // Asumiendo que esto devuelve la lista correcta de ItemsModel
    }
